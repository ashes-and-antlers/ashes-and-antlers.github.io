...
(`public/logo.png`). The logo is the cover: displayed at clamp(300px, 38vw,
520px) dead-center in a full-viewport hero — no frame, no tag — carrying
the wordmark, with the ember Enter the world action directly beneath it
and the scroll cue anchored to the hero's bottom edge. No nav. Every entry
